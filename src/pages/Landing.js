    ...
    <div className="landing">
      ...
      <nav className="landing-nav">
        <div className="landing-nav-inner">
          <div className="landing-brand">
            <img src="/logo-light.svg" alt="ITS VAULTED" className="nav-logo" />
          </div>
      ...
      <section className="landing-hero">
        <div className="landing-container">
          ...
          <p className="hero-sub">
            ITS VAULTED is the simplest way to manage your reselling business. Add items, mark them sold, and watch your P&L update in real time.
          </p>
      ...
      <section className="landing-section" id="features">
        <div className="landing-container">
          ...
          <p className="section-sub">Whether you flip sneakers, sell Pokémon cards, or trade anything in between — ITS VAULTED keeps you on top of it all.</p>
      ...
      <footer className="landing-footer">
        <div className="landing-container">
          <div className="landing-brand" style={{justifyContent:'center'}}>
            <img src="/logo-light.svg" alt="ITS VAULTED" className="footer-logo" />
          </div>
          <div className="footer-note">Built for resellers. © 2026 ITS VAULTED.</div>
